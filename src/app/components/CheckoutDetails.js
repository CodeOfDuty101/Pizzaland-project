    ...
    <div>
      {successMsg ? (
        ...
        <div className="lg:gap-x-8 h-full lg:px-12 lg:py-8">
          {/* title */}
          <h2 className="mb-6 text-[20px] uppercase font-extrabold text-center
          lg:text-left pt-6 lg:pt-0">
            Shipping & Checkout
          </h2>
          <div className="h-[86vh] lg:h-[60.5vh] flex flex-col lg:flex-row lg:gap-x-4">
            {/* box 1 */}
            ...
            {/* box 2 */}
            <div className="flex-1 h-full lg:max-w-[40%] flex flex-col 
              ...
              <div className="border rounded-lg flex flex-col mb-4 p-4 h-full">
                ...
                scrollbar-thumb-gray-200 scrollbar-track-white-500 font-semibold
                flex flex-col gap-y-4 h-[340px] py-2">
